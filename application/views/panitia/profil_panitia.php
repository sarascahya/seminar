...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <?php echo $biodata[0]->nama_depan." ".$biodata[0]->nama_belakang;?>
    </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-xs-12">
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-xs-3">
                <center><img src="<?php echo base_url('uploads/panitia/').$biodata[0]->foto;?>" width="200" height="200" class="img-thumnail"></center>
              </div>
              <div class="col-xs-9">
                <table class="table table-striped">
                  <tr>
                    <th class="col-xs-4">Nama Depan</th>
                    <td class="col-xs-8"><?php echo $biodata[0]->nama_depan;?></td>
                  </tr>
                  <tr>
                    <th class="col-xs-4">Nama Belakang</th>
                    <td class="col-xs-8"><?php echo $biodata[0]->nama_belakang;?></td>
                  </tr>
                  <tr>
          ...
          <div class="box-footer">
            <a class="btn btn-primary btn-flat pull-right" href="<?php echo site_url('panitia/editProfil/'.$biodata[0]->id)?>">Edit Profil</a>
