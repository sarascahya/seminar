  ...
  <body class="skin-blue fixed" style="background: #eee;">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-2 pull-right">
                <!-- <a type="button" class="btn bg-maroon navbar-btn" href="<?php echo site_url('panitia/loginPanitia');?>">Login Panitia</a> -->
    ...
    <div class="login-box <?php echo $this->session->flashdata('bounce');?>">
      <div class="login-logo">
        <a href="#!">Login <b class="text-blue">Panitia</b></a>
      </div><!-- /.login-logo -->
      <?php
      ...
      <div class="box box-info">
        <div class="login-box-body">
          <p class="login-box-msg">Silahkan login untuk ke halaman panitia</p>
          <form action="<?php echo base_url('panitia/cekLoginPanitia'); ?>" method="post">
          ...
          <div class="row">
            <div class="col-xs-6">
              <a href="<?php echo site_url('panitia/daftarPanitia');?>" class="text-center">Buat akun panitia</a>
              
            </div>
            <div class="col-xs-6 text-right">
              <a href="javascript:history.go(-1)">Batal Login</a>
            </div>
          </div>
        </div><!-- /.login-box-body -->
      </div>
