<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box box-success">
      ...
      <!-- form start -->
      <form class="form-horizontal" action="<?php echo site_url('peserta/prosesEditProfil');?>" enctype="multipart/form-data" method="post">
        <div class="box-body">
            <div class="form-group">
              <label for="judul" class="col-sm-3 control-label">Nama Lengkap</label>
              <div class="col-sm-7">
                <input type="hidden" name="id" value="<?php echo $biodata[0]->id?>">
                <input type="text" class="form-control" id="judul" placeholder="Nama Depan" name="nama_lengkap" value="<?php echo $biodata[0]->nama_lengkap?>" required>
              </div>
            </div>
            <div class="form-group">
              <label for="pembicara" class="col-sm-3 control-label">Nama Panggilan</label>
              <div class="col-sm-7">
                <input type="text" class="form-control" id="pembicara" placeholder="Nama Belakang" name="nama_panggilan" value="<?php echo $biodata[0]->nama_panggilan?>">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                ...
                <img src="<?php echo base_url('uploads/peserta/').$biodata[0]->foto?>" width="150px" height="150px" class=""><br><br>
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">Alamat</label>
                <div class="col-sm-7">
                  <textarea class="form-control" name="alamat" rows="8"><?php echo $biodata[0]->alamat?></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                ...
                <input type="hidden" class="form-control" id="judul" placeholder="Email" name="password" value="<?php echo $biodata[0]->password?>">
              </div>
            </div>
